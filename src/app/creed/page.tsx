    ...
    <>
      ...
      <SectionShell>
        <Reveal>
          <Prose>
            <p>
              시선교회는 대한예수교장로회 합신총회에 소속된 교회이며, 우리의
              신앙고백의 전체적인 요약은 웨스트민스터 신앙고백서에서 볼 수
              있고, 그 밖에 교회의 역사 속에 존재했던 믿음의 선조들의
              신앙고백을 존경하며 따릅니다. 또한 시선교회의 신앙고백이 21세기
              대한민국 도시에서 사는 사람들의 소망이나 두려움, 불안, 확신 등에
              연결되길 바랍니다.
            </p>
            <p>
              우리는 사람의 제일 되는 목적은{" "}
